	     ...
	     <div class="p-content">
            <div class="p-text">
                ...
                <div class="p-text-content">
                    <p>Вы можете оплатить Ваш заказ по безналичному расчету, через любой банк РФ. <br> Для выставления счета от
                    вас потребуется - карточка организации с банковскими реквизитами, телефон, адрес доставки,
                    а также электронный адрес. <br> Деньги поступают на расчетный счет на следующий день после оплаты. <br>
